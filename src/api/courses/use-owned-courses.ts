...
export const useOwnedCourses = createQuery<Response, Variables, AxiosError>({
  primaryKey: 'api/course/getOwnedCourses', // we recommend using  endpoint base url as primaryKey
