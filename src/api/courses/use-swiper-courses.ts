...
export const useSwiperCourses = createQuery<Response, Variables, AxiosError>({
  primaryKey: 'api/course/getSwiperCourses', // we recommend using  endpoint base url as primaryKey
