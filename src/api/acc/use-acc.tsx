...
export const useAcc = createQuery<Response, Variables, AxiosError>({
  primaryKey: 'hello', // we recommend using  endpoint base url as primaryKey
  queryFn: ({ queryKey: [primaryKey] }) => {
    ...
    return clientServer.get(`${primaryKey}`).then((response) => response.data);
  },
});
